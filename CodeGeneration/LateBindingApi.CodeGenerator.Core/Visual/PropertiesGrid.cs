...
namespace LateBindingApi.CodeGenerator.Core.Visual
{
    ...
    {      
        ...
        public PropertiesGrid()
        {
            ...
            dataGridViewMethods.Columns.Add("InvokeKind", "InvokeKind");
        ...
        public void Show(ItemFilter filter, XmlNode node)
        {
            ...
            XmlNode methodsNode = node.SelectSingleNode("Properties");
            foreach (XmlNode methodNode in methodsNode.ChildNodes)
            {
                ...
                foreach (XmlNode paramsNode in methodNode.SelectNodes("Parameters"))
                {
                    if (true == FilterPassed(paramsNode, name))
                    {
                        ...
                        ShowProperty(row, methodNode, paramsNode);
                    }
                }
            }
        ...
        private void ShowProperty(DataGridViewRow row, XmlNode methodNode, XmlNode paramsNode)
        {
            ...
            row.Cells[4].Value = methodNode.Attributes["InvokeKind"].InnerText;
        }
                    ...
                    case "Edit":
                        {
                            ...
                            if (dr == DialogResult.OK)
                            {
                                ...
                                ShowProperty(selectRow, methodNode, paramsNode);
                            }
                            break;
                        }
                    case "Delete":
        ...
        private void buttonResolve_Click(object sender, EventArgs e)
        {
            ...
            FormResolveMethodConflict resolveForm = new FormResolveMethodConflict(new FilterPassedMethod(FilterPassed), objectNode, "Properties");
