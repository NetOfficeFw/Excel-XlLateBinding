...
namespace LateBindingApi.Core
{
    public abstract class SinkHelper : IDisposable
    {
        ...
        public SinkHelper(CreatableObject eventClass)
        {
            _eventClass = eventClass;
        }

        public SinkHelper(NonCreatableObject eventClass)
        {
            _eventClass = eventClass;
        }
        ...
        public void SetupEventBinding(string guid)
        {
            ...
            {
                IConnectionPointContainer connectionPointContainer = (IConnectionPointContainer)_eventClass.COMProxy;
