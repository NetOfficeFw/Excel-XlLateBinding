...
namespace LateBindingApi.CodeGenerator.Core
{
    ...
    {   
        ...
        private static List<ValidationEventArgs> _list = new List<ValidationEventArgs>();
        ...
        public static List<ValidationEventArgs> Validate(XmlDocument document)
        {
            _list.Clear();
            document.Validate(OnValidation);
            return _list;
        }
        ...
        private static void OnValidation(object anything, ValidationEventArgs eventArgs)
        {
            _list.Add(eventArgs);
        }
