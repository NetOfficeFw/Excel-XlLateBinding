...
{
    internal partial class DispatchInterfaceHandler
    {
        #region Fields
        ...
        internal DispatchInterfaceHandler(COMComponentReader parent)        
        {
            _parent = parent;
        }
        ...
        private XmlNode CreateInterfaceNode(TLI.InterfaceInfo itemInterface, XmlNode facesNode, string interfaceName)
        {
            XmlNode ifaceNode = _parent.COMTree.CreateElement("Dispatch");
