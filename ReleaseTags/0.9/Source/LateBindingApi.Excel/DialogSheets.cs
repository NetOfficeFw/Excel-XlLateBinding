...
namespace LateBindingApi.Excel
{
	...
	public class DialogSheets : COMObject
	{
		#region Construction
		...
		public DialogSheets(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
