...
namespace LateBindingApi.Excel
{
	...
	public class LegendEntry : COMObject
	{
		...
		public LegendEntry(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.LegendKey LegendKey
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "LegendKey");
				if(null == returnValue)
					return null;
				LateBindingApi.Excel.LegendKey newClass = new LateBindingApi.Excel.LegendKey(this, returnValue);
				return newClass;
			}
		}
