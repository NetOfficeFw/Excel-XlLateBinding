...
namespace LateBindingApi.Excel
{
	...
	public class ShapeNodes : LateBindingApi.Office._IMsoDispObj
	{
		#region Construction
		...
		public IEnumerator GetEnumerator()
		{
            ...
            while (true == isMoveNextTrue)
            {
				...
				LateBindingApi.Excel.ShapeNode returnClass = new LateBindingApi.Excel.ShapeNode (this, itemProxy);
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.ShapeNode this[object index]
		{
			get
			{
				...
				if(null == returnValue)
					return null;
				LateBindingApi.Excel.ShapeNode newClass = new LateBindingApi.Excel.ShapeNode(this, returnValue);
				return newClass;
			}
		}
