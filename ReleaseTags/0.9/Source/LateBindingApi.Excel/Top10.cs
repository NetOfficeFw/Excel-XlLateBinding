...
namespace LateBindingApi.Excel
{
	...
	public class Top10 : COMObject
	{
		...
		public Top10(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL12","XL14")]
		public LateBindingApi.Excel.Enums.XlTopBottom TopBottom
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "TopBottom");
				return (LateBindingApi.Excel.Enums.XlTopBottom)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "TopBottom", value);
			}						
		}
		...
		public Int32 Rank
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "Rank");
				return (Int32)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "Rank", value);
			}						
		}
		...
		public bool Percent
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "Percent");
				return (bool)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "Percent", value);
			}						
		}
		...
		[SupportByLibrary("XL12","XL14")]
		public LateBindingApi.Excel.Enums.XlCalcFor CalcFor
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "CalcFor");
				return (LateBindingApi.Excel.Enums.XlCalcFor)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "CalcFor", value);
			}						
		}
