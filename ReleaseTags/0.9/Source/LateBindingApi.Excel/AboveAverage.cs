...
namespace LateBindingApi.Excel
{
	...
	public class AboveAverage : COMObject
	{
		...
		public AboveAverage(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL12","XL14")]
		public LateBindingApi.Excel.Enums.XlAboveBelow AboveBelow
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "AboveBelow");
				return (LateBindingApi.Excel.Enums.XlAboveBelow)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "AboveBelow", value);
			}						
		}
		...
		public Int32 NumStdDev
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "NumStdDev");
				return (Int32)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "NumStdDev", value);
			}						
		}
