...
namespace LateBindingApi.Excel
{
	...
	public class Parameters : COMObject
	{
		#region Construction
		...
		public Parameters(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.Parameter Add(string name, object iDataType)
		{
			object[] paramArray = new object[2];
			paramArray[0] = name;
			paramArray[1] = iDataType;
			object returnValue = Invoker.MethodReturn(this, "Add", paramArray);
			if(null == returnValue)
				return null;
			LateBindingApi.Excel.Parameter newClass = new LateBindingApi.Excel.Parameter(this, returnValue);
