...
namespace LateBindingApi.Excel
{
	...
	public class OptionButtons : COMObject
	{
		#region Construction
		...
		public OptionButtons(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.GroupBox GroupBox
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "GroupBox");
				if(null == returnValue)
					return null;
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.OptionButton Add(Double left, Double top, Double width, Double height)
		{
			object[] paramArray = new object[4];
			paramArray[0] = left;
			paramArray[1] = top;
