...
namespace LateBindingApi.Excel
{
	...
	public class ErrorBars : COMObject
	{
		...
		public ErrorBars(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.Enums.XlEndStyleCap EndStyle
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "EndStyle");
				return (LateBindingApi.Excel.Enums.XlEndStyleCap)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "EndStyle", value);
			}						
		}
