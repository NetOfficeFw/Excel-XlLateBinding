...
namespace LateBindingApi.Excel
{
	...
	public class ToolbarButtons : COMObject
	{
		#region Construction
		...
		public ToolbarButtons(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.ToolbarButton this[Int32 index]
		{
			get
			{
