...
{
    public class XlNames : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlNames(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        public XlName Add()
        {
            ...
            XlName newClass = new XlName(this, returnValue);
        ...
        /// <summary>
        /// returns a XlName by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlName this[int index]
        {
            get
            {
        ...
        {
            int iCount = Count;
            XlName[] res_addins = new XlName[iCount];
