...
{    
    public class XlScenarios : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction
        ...
        /// <summary>
        /// returns an XlScenario by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlScenario this[int index]
        {
            get
            {
                ...
                if (null == returnValue) return null;
                XlScenario newClass = new XlScenario(this, returnValue);
                ListChildReferences.Add(newClass);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlScenario[] res_addins = new XlScenario[iCount];
