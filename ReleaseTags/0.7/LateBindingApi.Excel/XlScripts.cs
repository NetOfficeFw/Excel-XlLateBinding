...
namespace LateBindingApi.Excel
{
    ...
    public class XlScripts : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlScripts(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an XlScript by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlScript this[int index]
        {
            get
            {
        ...
        {
            int iCount = Count;
            XlScript[] res_addins = new XlScript[iCount];
