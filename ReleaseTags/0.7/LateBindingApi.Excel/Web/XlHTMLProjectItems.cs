...
{
    public class XlHTMLProjectItems : XlNonCreatable, System.Collections.IEnumerable
    {   
        #region Construction

        internal XlHTMLProjectItems(IXlObject parentReference, object comReference): base(parentReference, comReference)
		{		 
		}
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public XlHTMLProjectItem this[int index]
        {
            get
            {
                ...
                if (null == returnValue) return null;
                XlHTMLProjectItem newClass = new XlHTMLProjectItem(this, returnValue);
                ListChildReferences.Add(newClass);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlHTMLProjectItem[] res_addins = new XlHTMLProjectItem[iCount];
