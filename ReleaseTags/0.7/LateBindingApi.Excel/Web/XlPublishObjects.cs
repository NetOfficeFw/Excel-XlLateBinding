...
{
    public class XlPublishObjects : XlNonCreatable, System.Collections.IEnumerable
    {   
        #region Construction

        internal XlPublishObjects(IXlObject parentReference, object comReference): base(parentReference, comReference)
		{			 
		}
        ...
        public XlPublishObject this[int index]
        {
            get
            {
                ...
                XlPublishObject newClass = new XlPublishObject(this, returnValue);
        ...
        {
            int iCount = Count;
            XlPublishObject[] res_addins = new XlPublishObject[iCount];
