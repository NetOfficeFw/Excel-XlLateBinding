...
{
    public class XlAreas : XlNonCreatable, System.Collections.IEnumerable
    {      
        #region Construction

        internal XlAreas(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
