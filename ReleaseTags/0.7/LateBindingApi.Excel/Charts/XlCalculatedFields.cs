...
{
    public class XlCalculatedFields : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction
        ...
        /// <summary>
        /// returns an PivotField by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlPivotField this[int index]
        {
            get
            {
                ...
                if (null == comRef) return null;
                XlPivotField newClass = new XlPivotField(this, comRef);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlPivotField[] res_addins = new XlPivotField[iCount];
