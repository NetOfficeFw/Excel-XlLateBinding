...
{
    public class XlLegend : XlNonCreatable
    {
        #region Construction

        internal XlLegend(IXlObject parentReference, object comReference): base(parentReference, comReference)
		{			 
		}
        ...
        public XlLegendPosition Position
        {
            get
            {
                ...
                return (XlLegendPosition)returnValue;
            }
            set
            {
                object[] paramArray = new object[1];
