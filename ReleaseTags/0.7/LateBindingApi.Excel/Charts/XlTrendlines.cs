...
{
    public class XlTrendlines : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlTrendlines(IXlObject parentReference, object comReference): base(parentReference, comReference)
		{
		}
        ...
        /// <summary>
        /// returns an XlTrendline by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlTrendline this[int index]
        {
            get
            {
                ...
                if (null == returnValue) return null;
                XlTrendline newClass = new XlTrendline(this, returnValue);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlTrendline[] res_addins = new XlTrendline[iCount];
