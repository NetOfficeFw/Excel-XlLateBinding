...
{
    public class XlAxes : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlAxes(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an XlAxis by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlAxis this[int index]
        {
            get
            {
        ...
        {
            int iCount = Count;
            XlAxis[] res_addins = new XlAxis[iCount];
