...
{
    public class XlPoints : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlPoints(IXlObject parentReference, object comReference) : base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an XlPoint by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlPoint this[int index]
        {
            get
            {
                ...
                XlPoint newClass = new XlPoint(this, returnValue);
        ...
        {
            int iCount = Count;
            XlPoint[] res_addins = new XlPoint[iCount];
