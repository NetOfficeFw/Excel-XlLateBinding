...
{
    public class XlCodePanes : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlCodePanes(IXlObject parentReference, object comReference) : base(parentReference, comReference)
        {
        }
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public XlCodePane this[int index]
        {
            get
            {
        ...
        {
            int iCount = Count;
            XlCodePane[] res_addins = new XlCodePane[iCount];
