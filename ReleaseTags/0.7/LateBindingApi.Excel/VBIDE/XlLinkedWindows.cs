...
{
    public class XlLinkedWindows: XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlLinkedWindows(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an XlLinkedWindow by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
