...
{
    public class XlCustomViews : XlNonCreatable, System.Collections.IEnumerable
    {  
        #region Construction

        internal XlCustomViews(IXlObject parentReference, object comReference) : base(parentReference, comReference)
		{			 
		}
        ...
        public XlCustomView this[string viewName]
        {
            get
            {
                object[] paramArray = new object[1];
                paramArray[0] = viewName;
                ...
                XlCustomView newClass = new XlCustomView(this, returnValue);
                ListChildReferences.Add(newClass);
                return newClass;
            }
        }

        public XlCustomView this[int index]
        {
            get
            {
                object[] paramArray = new object[1];
        ...
        {
            int iCount = Count;
            XlCustomView[] res_addins = new XlCustomView[iCount];
