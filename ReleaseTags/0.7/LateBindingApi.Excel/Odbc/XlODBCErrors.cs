...
{
    public class XlODBCErrors : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlODBCErrors(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an ODBCError by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlODBCError this[int index]
        {
            get
            {
                ...
                XlODBCError newClass = new XlODBCError(this, returnValue);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlODBCError[] res_addins = new XlODBCError[iCount];
