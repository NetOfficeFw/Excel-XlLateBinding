...
{
    public class XlFilters : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlFilters(IXlObject parentReference, object comReference) : base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an XlFilter by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlFilter this[int index]
        {
            get
            {
                ...
                if (null == returnValue) return null;
                XlFilter newClass = new XlFilter(this, returnValue);
                ListChildReferences.Add(newClass);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlFilter[] res_addins = new XlFilter[iCount];
