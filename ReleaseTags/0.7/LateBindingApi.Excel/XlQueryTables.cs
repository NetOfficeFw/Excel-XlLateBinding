...
{    
    ...
    public class XlQueryTables : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlQueryTables(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns a XlQueryTable by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlQueryTable this[int index]
        {
            get
            {
        ...
        {
            int iCount = Count;
            XlQueryTable[] res_addins = new XlQueryTable[iCount];
