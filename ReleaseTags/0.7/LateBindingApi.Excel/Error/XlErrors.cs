...
{    
    ...
    public class XlErrors : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlErrors(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <summary>
        /// returns an XlError by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlError this[int index]
        {
            get
            {
                ...
                if (null == returnValue) return null;
                XlError newClass = new XlError(this, returnValue);
                ListChildReferences.Add(newClass);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlError[] res_addins = new XlError[iCount];
