...
{
    public class XlCustomProperties : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlCustomProperties(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        public XlCustomProperty Add(string name, object value)
        {
            ...
            XlCustomProperty newClass = new XlCustomProperty(this, returnValue);
        ...
        /// <summary>
        /// returns an XlCustomProperty by Index, not 0 based
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        public XlCustomProperty this[int index]
        {
            get
            {
                object[] paramArray = new object[1];
        ...
        {
            int iCount = Count;
            XlCustomProperty[] res_addins = new XlCustomProperty[iCount];
