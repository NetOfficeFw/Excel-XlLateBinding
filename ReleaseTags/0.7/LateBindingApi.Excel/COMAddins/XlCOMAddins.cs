...
{    
    /// <summary>
    /// Represents the COMAddin Collection
    /// </summary>
    public class XlCOMAddins : XlNonCreatable, System.Collections.IEnumerable
    {
        #region Construction

        internal XlCOMAddins(IXlObject parentReference, object comReference): base(parentReference, comReference)
        {
        }
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public XlCOMAddin this[int index]
        {
            get
            {
                ...
                if (null == returnValue) return null;
                XlCOMAddin newClass = new XlCOMAddin(this, returnValue);
                ListChildReferences.Add(newClass);
                return newClass;
            }
        }
        ...
        {
            int iCount = Count;
            XlCOMAddin[] res_addins = new XlCOMAddin[iCount];
