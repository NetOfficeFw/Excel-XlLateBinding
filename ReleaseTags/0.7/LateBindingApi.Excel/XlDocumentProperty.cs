...
{
    public class XlDocumentProperty : XlNonCreatable
    {
        #region Construction

        internal XlDocumentProperty(IXlObject parentReference, object comReference): base(parentReference, comReference)
		{			 
		}
