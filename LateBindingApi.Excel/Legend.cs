...
namespace LateBindingApi.Excel
{
	...
	public class Legend : COMObject
	{
		...
		public Legend(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.Enums.XlLegendPosition Position
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "Position");
				return (LateBindingApi.Excel.Enums.XlLegendPosition)returnValue;
			}
			set
			{
