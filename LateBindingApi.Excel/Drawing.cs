...
namespace LateBindingApi.Excel
{
	...
	public class Drawing : COMObject
	{
		...
		public Drawing(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		public COMVariant Vertices
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "Vertices", null);
				COMVariant returnObject = LateBindingApi.Core.Factory.CreateVariantFromComProxy(this, returnValue);
				return returnObject;
			}
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public COMVariant get_Vertices(object index1, object index2)
		{
			object[] paramArray = new object[2];
			paramArray[0] = index1;
			paramArray[1] = index2;
			object returnValue = Invoker.PropertyGet(this, "Vertices", paramArray);
			COMVariant returnObject = LateBindingApi.Core.Factory.CreateVariantFromComProxy(this, returnValue);
			return returnObject;
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public COMVariant AddVertex(Double left, Double top)
		{
			object[] paramArray = new object[2];
			paramArray[0] = left;
			paramArray[1] = top;
			object returnValue = Invoker.MethodReturn(this, "AddVertex", paramArray);
			COMVariant returnObject = LateBindingApi.Core.Factory.CreateVariantFromComProxy(this, returnValue);
			return returnObject;
		}

		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public COMVariant Reshape(Int32 vertex, bool insert)
		{
			object[] paramArray = new object[2];
			paramArray[0] = vertex;
			paramArray[1] = insert;
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public COMVariant Reshape(Int32 vertex, bool insert, object left, object top)
		{
			object[] paramArray = new object[4];
			paramArray[0] = vertex;
			paramArray[1] = insert;
