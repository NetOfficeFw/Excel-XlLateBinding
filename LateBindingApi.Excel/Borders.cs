...
namespace LateBindingApi.Excel
{
	...
	public class Borders : COMObject
	{
		#region Construction
		...
		public Borders(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.Border this[LateBindingApi.Excel.Enums.XlBordersIndex index]
		{
			get
			{
		...
		public IEnumerator GetEnumerator()
		{
            ...
            while (true == isMoveNextTrue)
            {
				...
				LateBindingApi.Excel.Border returnClass = new LateBindingApi.Excel.Border (this, itemProxy);
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.Border get__Default(LateBindingApi.Excel.Enums.XlBordersIndex index)
		{
			object[] paramArray = new object[1];
			paramArray[0] = index;
