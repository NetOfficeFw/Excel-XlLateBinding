...
namespace LateBindingApi.Excel
{
	...
	public class Watches : COMObject
	{
		#region Construction
		...
		public Watches(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14")]
		public LateBindingApi.Excel.Watch this[object index]
		{
			get
			{
				object[] paramArray = new object[1];
