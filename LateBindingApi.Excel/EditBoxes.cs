...
namespace LateBindingApi.Excel
{
	...
	public class EditBoxes : COMObject
	{
		#region Construction
		...
		public EditBoxes(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		public bool PasswordEdit
		{
			get
			{
				object returnValue = Invoker.PropertyGet(this, "PasswordEdit");
				return (bool)returnValue;
			}
			set
			{
				Invoker.PropertySet(this, "PasswordEdit", value);
			}						
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.EditBox Add(Double left, Double top, Double width, Double height)
		{
			object[] paramArray = new object[4];
			paramArray[0] = left;
			paramArray[1] = top;
			...
			if(null == returnValue)
				return null;
			LateBindingApi.Excel.EditBox newClass = new LateBindingApi.Excel.EditBox(this, returnValue);
			return newClass;
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public COMVariant this[object index]
		{
			get
			{
				object[] paramArray = new object[1];
