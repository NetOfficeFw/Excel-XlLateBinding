...
namespace LateBindingApi.Excel
{
	...
	public class QueryTables : COMObject
	{
		#region Construction
		...
		public QueryTables(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.QueryTable get__Default(object index)
		{
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.QueryTable Add(object connection, LateBindingApi.Excel.Range destination, object sql)
		{
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.QueryTable this[object index]
		{
			get
			{
				object[] paramArray = new object[1];
		...
		public IEnumerator GetEnumerator()
		{
            ...
            while (true == isMoveNextTrue)
            {
				...
				LateBindingApi.Excel.QueryTable returnClass = new LateBindingApi.Excel.QueryTable (this, itemProxy);
