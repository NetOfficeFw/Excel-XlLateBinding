...
namespace LateBindingApi.Excel
{
	...
	public class XmlMaps : COMObject
	{
		#region Construction
		...
		public XmlMaps(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL11","XL12","XL14")]
		public LateBindingApi.Excel.XmlMap this[object index]
		{
			get
			{
				object[] paramArray = new object[1];
		...
		[SupportByLibrary("XL11","XL12","XL14")]
		public LateBindingApi.Excel.XmlMap Add(string schema, object rootElementName)
		{
			object[] paramArray = new object[2];
			paramArray[0] = schema;
			paramArray[1] = rootElementName;
			object returnValue = Invoker.MethodReturn(this, "Add", paramArray);
			if(null == returnValue)
				return null;
			LateBindingApi.Excel.XmlMap newClass = new LateBindingApi.Excel.XmlMap(this, returnValue);
