...
namespace LateBindingApi.Excel
{
	...
	public class Arcs : COMObject
	{
		...
		public Arcs(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.Arc Add(Double x1, Double y1, Double x2, Double y2)
		{
			object[] paramArray = new object[4];
			paramArray[0] = x1;
			paramArray[1] = y1;
