...
namespace LateBindingApi.Excel
{
	...
	public class GroupBoxes : COMObject
	{
		#region Construction
		...
		public GroupBoxes(COMObject parentObject, object comProxy, Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14","XL9")]
		public LateBindingApi.Excel.GroupBox Add(Double left, Double top, Double width, Double height)
		{
			object[] paramArray = new object[4];
			paramArray[0] = left;
			paramArray[1] = top;
